...
function GroupCalendar.UI._EventEditor:Initialize()
	...
	self.EventTypeMenu = GroupCalendar:New(GroupCalendar.UIElementsLib._DropDownMenu, self, function (...) self:EventTypeMenuFunc(...) end, 150)
	...
	self.DifficultyMenu = GroupCalendar:New(GroupCalendar.UIElementsLib._DropDownMenu, self, function (...) self:DifficultyMenuFunc(...) end, 65)
	...
	self.EventModeMenu = GroupCalendar:New(GroupCalendar.UIElementsLib._DropDownMenu, self, function (...) self:EventModeMenuFunc(...) end, 220)
	...
	self.DurationMenu = GroupCalendar:New(GroupCalendar.UIElementsLib._DropDownMenu, self, function (...) self:DurationMenuFunc(...) end)
	...
	self.RepeatMenu = GroupCalendar:New(GroupCalendar.UIElementsLib._DropDownMenu, self, function (...) self:RepeatMenuFunc(...) end)
	...
	self.LockoutMenu = GroupCalendar:New(GroupCalendar.UIElementsLib._DropDownMenu, self, function (...) self:LockoutMenuFunc(...) end)
