...
GroupCalendar.cVersionString = GetAddOnMetadata("GroupCalendar5", "Version")
...
GroupCalendar.cBirthdayTitleFormat = "%s's Birthday"
...
[[
	...
	<p>* You and a player from the partner guild must be running a current version Group Calendar 5<br/>
	* Both of you must be viewing the Partners tab in Group Calendar<br/>
...
GroupCalendar.cConfirmPartnerRequest = "%s is requesting a Group Calendar partnership with you."
...
GroupCalendar.cRememberInvites = "Remember event invitation lists"
...
GroupCalendar.cWaitingForServerInvite = "Waiting for server"
GroupCalendar.cAddingInviteFormat = "Adding %s"
...
GroupCalendar.cConfirmReset = "Are you sure you want to reset Group Calendar? You will not lose events, but you will lose partnerships, role assignments, and other local settings."

GroupCalendar.cRespondedDateFormat = "Responded on %s"

GroupCalendar.cInviteErrorMessage = "Canceled invite processing because of a server error: %s"
GroupCalendar.cInvitesCanceledMessage = "Canceled invite processing because the event was closed."

GroupCalendar.cStartDayLabel = "Start week on:"
GroupCalendar.cShowMinimapClock = "Show analog clock on minimap"
