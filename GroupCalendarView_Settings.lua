...
function GroupCalendar.UI._SettingsView:OnShow()
	if not self.Initialized then
		...
		self.ThemeMenu = GroupCalendar:New(GroupCalendar.UIElementsLib._DropDownMenu, self, function (...) self:ThemeMenuFunc(...) end, 130)
		...
		self.StartDayMenu = GroupCalendar:New(GroupCalendar.UIElementsLib._DropDownMenu, self, function (...) self:StartDayMenuFunc(...) end, 130)
	...
	self.ThemeMenu:SetSelectedValue(GroupCalendar.Data.ThemeID or "SEASONAL")
...
function GroupCalendar.UI._SettingsView:ThemeMenuFunc(pMenu, pMenuID)
	local vCurrentThemeID = GroupCalendar.Data.ThemeID or "SEASONAL"
