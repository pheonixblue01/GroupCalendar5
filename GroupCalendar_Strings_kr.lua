...
GroupCalendar.cGeneralEventGroup = "일반"
...
GroupCalendar.cDungeonEventGroup = "던전 (Classic)"
GroupCalendar.cOutlandsDungeonEventGroup = "던전 (Burning Crusade)"
GroupCalendar.cWotLKDungeonEventGroup = "던전 (WotLK)"
...
GroupCalendar.cBattlegroundEventGroup = "전장"
GroupCalendar.cOutdoorRaidEventGroup = "Outdoor Raids"

GroupCalendar.cMeetingEventName = "만남"
GroupCalendar.cBirthdayEventName = "생일"
...
GroupCalendar.cLevelRangeFormat = "%i 레벨 부터 %i 레벨"
GroupCalendar.cMinLevelFormat = "%i 레벨 이상"
GroupCalendar.cMaxLevelFormat = "최대 %i 레벨"
GroupCalendar.cAllLevels = "모든 레벨"
GroupCalendar.cSingleLevel = "%i 레벨"

GroupCalendar.cYes = "예. 이벤트에 참가하겠습니다."
GroupCalendar.cNo = "아니오. 이벤트에 참가하지 않습니다."
...
GroupCalendar.cTimeLabel = "시간:"
GroupCalendar.cDurationLabel = "소요시간:"
GroupCalendar.cEventLabel = "이벤트:"
GroupCalendar.cTitleLabel = "타이틀:"
GroupCalendar.cLevelsLabel = "레벨:"
GroupCalendar.cLevelRangeSeparator = "-"
GroupCalendar.cDescriptionLabel = "설명"
GroupCalendar.cCommentLabel = "남길말:"
...
GroupCalendar.cPluralMinutesFormat = "%d 분"
GroupCalendar.cSingularHourFormat = "%d 시간"
GroupCalendar.cPluralHourFormat = "%d 시간"
GroupCalendar.cSingularHourPluralMinutes = "%d 시간 %d 분"
GroupCalendar.cPluralHourPluralMinutes = "%d 시간 %d 분"

GroupCalendar.cNewerVersionMessage = "A newer version is available (%s)"

GroupCalendar.cDelete = "삭제"
...
GroupCalendar.cTimeDateRangeFormat = "%s\r %s 에서 %s"
