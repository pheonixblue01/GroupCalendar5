...
function GroupCalendar.UI._RoleLimitsDialog:Open(pLimits, pTitle, pShowPriority, pSaveFunction)
	if not self.Initialized then
		...
		self.PriorityMenu = GroupCalendar:New(GroupCalendar.UIElementsLib._DropDownMenu, self.PriorityFrame, function (pMenu, pValue, pLevel)
		...
		self.MaxPartySizeMenu = GroupCalendar:New(GroupCalendar.UIElementsLib._DropDownMenu, self, function (pMenu, pValue, pLevel)
...
function GroupCalendar.UI._ClassLimitsDialog:Initialize()
	...
	self.PriorityMenu = GroupCalendar:New(GroupCalendar.UIElementsLib._DropDownMenu, self, function (pMenu, pValue, pLevel)
		pMenu:AddNormalItem(GroupCalendar.cPriorityDate, "DATE")
		pMenu:AddNormalItem(GroupCalendar.cPriorityRank, "RANK")
	end, 130)
	self.PriorityMenu:SetTitle(GroupCalendar.cPriorityLabel)
